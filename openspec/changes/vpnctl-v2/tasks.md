...
- [x] 14.3 Update the curl installer to verify signed metadata/checksums and install the standard binary/bundle layout; verify corrupt downloads leave the existing installation untouched.
