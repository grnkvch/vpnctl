...
- [x] 8.3 Run the focused E2E against the same frozen source commit used in both manual scenarios; verify both modes pass and a failed mode remains in the focused loop rather than triggering any general release gate.
