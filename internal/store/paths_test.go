...
func TestDefaultPaths(t *testing.T) {
	...
	want := Paths{
		...
		ConvergenceFile:    "/var/lib/vpnctl/convergence.json",
		AppliedMaterialDir: "/var/lib/vpnctl/applied-material",
...
func TestNewPathsUsesExplicitTestRoot(t *testing.T) {
	...
	want := map[string]string{
		...
		"convergence": filepath.Join(root, "var", "lib", "vpnctl", "convergence.json"),
		"material":    filepath.Join(root, "var", "lib", "vpnctl", "applied-material"),
	...
	got := map[string]string{
		...
		"convergence": paths.ConvergenceFile,
		"material":    paths.AppliedMaterialDir,
